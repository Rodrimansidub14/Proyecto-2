...
function Get-JavaVersion
{
  ...
  process {
    ...
    # Anything less then 18 is some Java 11 version
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBgnlzPOI4XpGtW
# LvCq0SP04qMOVd+bY+Fdzq4u5N8eCaCCDcIwggPFMIICraADAgECAgEAMA0GCSqG
...
# CzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIPja55ExBE15lLmNCO0K
# AmAqHPmc2bqQ0ibsO3gUF4YtMA0GCSqGSIb3DQEBAQUABIIBABRcp+LsCBfyNevk
# BY/FODyvbleKmuy/lWYT5Od03RTDfpCLoRQuNahuVrxcliIpH5WaFetmh829VZNK
# PEEG+ik9teQIXM5+r1J6fFXu8fZSGlBIhH6AMb18N8J7xRS+2w8fP//ZYxKxiDfh
# yiiyAO/bx2rQchFuZ16W/P42vo+PvnTxRpTqJh0Z03KSENWb62+BRsHtVQ2hITNV
# Ifjz7NggXp5vYe4Yg4LTCaMma/5FuG+AN+JJMct8RXrax/d/fznl39Cxnv+ZkUA4
# Mxn8oNTBA503zMrzau7fRMugDXKJHdCkZtvhgINEedK/7GDZJob1rc3ZVgmHk6ri
# PYGXBMk=
